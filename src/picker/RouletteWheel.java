...
public class RouletteWheel {
	...
	// static constants
	public final static String DATA_FILE = "resources/example.txt";
	public final static String WHEEL_FILE = "resources/American_roulette-wheel.gif";
	public final static String MUSIC_FILE = "resources/roulette.wav";
    ...
    public static void main(String[] args) {
    	...
    	while (counter > 0) {
    		...
    		StdDraw.picture(0.5, 0.5, WHEEL_FILE, rotation % 360);
